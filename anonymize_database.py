...
class Anonymize:
    ...
    def __init__(self):
        self.phi_database=r'S:/development'
        self.anonymize_database=r'S:/anonymous_database'
        ...
        self.database=['consecutive_PIRADS']
            ...
            for file in os.listdir(dir):
                if file != 'practice' and file!= 'template' and file!='template-Copy':
                    ...
                    if str(random_num) not in os.listdir(os.path.join(self.anonymize_database,database)) and file not in keys['original_id'].tolist():
                        ...
                        os.mkdir(os.path.join(self.anonymize_database, database, str(random_num)))
                        shutil.copytree(os.path.join(self.phi_database, database, file, 'nifti'), os.path.join(self.anonymize_database, database, str(random_num), 'nifti'))
                        shutil.copytree(os.path.join(self.phi_database, database, file, 'voi'), os.path.join(self.anonymize_database, database, str(random_num), 'voi'))
                    else:
...
if __name__=='__main__':
    ...
    Anonymize().anonymize_ID_transfer()
